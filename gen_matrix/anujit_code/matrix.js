...
// js function for drawing matrix
  draw=function(){

    var numWhite= 100-parseInt(numBlack)
    {/* declaring new array of numBlack length, and fill with 0s */}
    var blackArray=Array(numBlack).fill(0)
    {/* declare a new array of numWhite length, and fill with 1s */}
    var whiteArray=Array(numWhite).fill(1)
    {/* concatenate the above 2 arrays and shuffle the elements */}
